...
<template>
  ...
  <div class="progress__content">
    ...
    <section class="music__controls">
      ...
      <button class="previous__song" @click="prev"><img src="../../../src/assets/control-icons/next.png" alt="">
      </button>
      <button class="toggle__pause" @click="play" v-if="!isPlaying"><img
          src="../../../src/assets/control-icons/play.png" alt=""></button>
      <button class="toggle__pause" @click="play" v-if="isPlaying"><img
          src="../../../src/assets/control-icons/pause.png" alt=""></button>
